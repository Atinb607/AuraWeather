    ...
    <Card className="backdrop-blur-md bg-gray-800/30 border-gray-700/50 p-6 transition-all hover:bg-gray-700/40 h-full flex flex-col">
      ...
      <div className="flex-grow flex items-center justify-center">
        <div className="relative w-48 h-48">
          ...
          <div
            className="absolute top-1/2 left-1/2 w-1 h-16 bg-blue-400 rounded-full"
            style={{
          ...
          ></div>
          <div
            className="absolute top-1/2 left-1/2 w-1 h-20 bg-green-400 rounded-full"
            style={{
          ...
          ></div>
          <div
            className="absolute top-1/2 left-1/2 w-0.5 h-24 bg-red-400 rounded-full"
            style={{
